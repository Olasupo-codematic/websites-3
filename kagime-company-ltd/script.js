/**
 * Kagime Company Limited - Frontend Scripts
 * Handles dynamic product rendering, smooth scrolling, form validation, and modals.
 */
  ...
  PRODUCTS_DATA.forEach((product) => {
    const cardHTML = `
            <div class="product-card" aria-labelledby="product-${product.id}-title">
                ...
                <button class="btn btn-primary buy-now-btn" data-product-id="${product.id}" aria-label="Purchase ${product.title}">Buy Now</button>
            </div>
        `;
