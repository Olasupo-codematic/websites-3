...
const audioBooks = [
  {
    ...
    "id": "98f00060-2d90-415d-8d38-e62c9c4fcb9f"
  },
  {
    ...
    "id": "ea4efc8c-2454-4926-acc8-be8d7e9834fa"
  },
  {
    ...
    "id": "0f78a6c4-a39a-45f4-9fca-6b8631062845"
  },
  {
    ...
    "id": "664b8b04-a452-46e2-872d-0c3bf3daea4c"
  },
  {
    ...
    "id": "7cc6ace3-a175-4d73-b767-01f0f3b1ad1a"
  }
];
...
const renderBooks = () => {
            ...
            <div class="book-card fade-in">
                ...
                <div class="p-5 flex flex-col flex-grow">
                    ...
                    <div class="mt-auto pt-4 border-t border-gray-100">
                        ...
                        <button class="btn btn-primary mt-3 text-sm block w-full buy-now-btn" data-product-index="${index}">Buy Now</button>
                    </div>
                </div>
            </div>
        `;
    ...
    document.querySelectorAll('.buy-now-btn').forEach(button => {
        button.addEventListener('click', (e) => {
            ...
            const product = audioBooks[index];
