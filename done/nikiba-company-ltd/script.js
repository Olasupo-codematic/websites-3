    ...
    const PRODUCT_DATA = [
        {
          ...
          "price_kes": "6,500.00",
          "icon": "💼",
          "id": "8e5cd8e9-39a4-4d2d-b089-533214f079d9"
        },
        {
          ...
          "price_kes": "7,800.00",
          "icon": "📊",
          "id": "f9070bcc-3567-41e4-8dd2-0885d91066e1"
        },
        {
          ...
          "price_kes": "5,000.00",
          "icon": "🧠",
          "id": "279d6084-55bc-440f-abd7-4e2b2ce18305"
        },
        {
          ...
          "price_kes": "9,500.00",
          "icon": "💰",
          "id": "1408ab65-cfc6-456f-8761-b90f2a79762d"
        }
    ];
    ...
    if (ebookPackagesContainer) {
        PRODUCT_DATA.forEach((product, index) => {
            ...
            card.innerHTML = `
                ...
                <button class="btn btn-secondary buy-now-btn" data-product-index="${index}">Buy Now</button>
            `;
        ...
        document.querySelectorAll('.buy-now-btn').forEach(button => {
            button.addEventListener('click', (e) => {
                ...
                const product = PRODUCT_DATA[index];
